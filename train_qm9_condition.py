...
if __name__ == '__main__':
    ...
    config_name = 'qm9_EGNN_context_Cv_test'#'qm9_full_temb_charge_norm_edmdataset'
    ...
    if len(args.context)>0:
        ...
        train_set = train_set[torch.tensor(split_idx, dtype=torch.long)]  # 使用 PyTorch 张量索引
    ...
    if len(args.context) > 0:
        ...
        property_norms_val = compute_mean_mad(train_set, args.context, args.dataset)
